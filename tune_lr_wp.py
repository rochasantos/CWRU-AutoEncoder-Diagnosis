# tune_lr_wp_sgkfold_all_setups.py
# ---------------------------------------------------------
# Logistic Regression + Optuna with StratifiedGroupKFold (4 folds)
...
def make_objective(all_train_data, n_splits=4, seed=42):
    ...
    def objective(trial):
        ...
        # if penalty == "none", C is ignored (we won't pass it)
        if penalty != "none":
...
def main():
    ...
    # import json
    # with open("lr_wp_optuna_all_setups_best_params.json", "w") as f:
