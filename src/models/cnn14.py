...
# The model uses Batch Normalization after each convolutional layer and sigmoid activation
# in the final layer.
class CNN1D(nn.Module):
    def __init__(self, input_length, num_classes=2):
        ...
        self.conv2 = nn.Conv1d(in_channels=16, out_channels=32, kernel_size=32)
        self.norm2 = nn.BatchNorm1d(32)
        self.pool2 = nn.MaxPool1d(kernel_size=8)

        self.conv3 = nn.Conv1d(in_channels=32, out_channels=64, kernel_size=64)
