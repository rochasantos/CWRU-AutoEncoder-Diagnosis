...
def _extract_acquisition_from_path(p: str):
    ...
    try:
        ...
        return acq  # fallback string se não for numérico
...
def make_objective(all_train_data, n_splits=4, seed=42):
    ...
    Cria o objetivo do Optuna:
      - Para cada trial, avalia a DT com StratifiedGroupKFold em CADA setup
...
def main():
    ...
    study.optimize(objective, n_trials=60)  # ajuste n_trials conforme recursos/tempo
